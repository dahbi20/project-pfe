...
<center>
  ...
  <a href="chapter.php?b=1"><div style="background: url(images/micro.jpg);color: #333;" class="dash-opt">Administration des Systèmes d’exploitation</div></a>
  <a href="chapter.php?b=2"><div style="background: url(images/macro.jpg);color: #f0f8ff;" class="dash-opt">PHP</div></a>
  <a href="chapter.php?b=1"><div style="background: url(images/micro.jpg);color: #333;" class="dash-opt">Langage C</div></a>
