...
<div class="login">
    ...
    <?php
      if (isset($_COOKIE['email'])) {
        ...
        <a href="dashboard.php"><li>Dashboard</li></a>
    		<a href="log.php?out"><li>Se déconnecter</li></a>
    		<?php 
  ...
  <div class="dropdown-content">
    <a href="register_teacher.php">Je suis un enseignant</a>
    <a href="register.php">Je suis étudiant</a>
  </div>
</div>
        <?php
      }
	...
	<div class="header">
		<div class="container">
			<div class="header-main">
				<div class="logo">
			       <h1><span class="books"></span> <a href="index.php">Elearning-ESTG</a></h1>
			    </div>
				 <div class="top-nav">
				     ...
				     <nav class="cl-effect-21" id="cl-effect-21">
							<ul class="res">
								...
								<li><a href="pricing.php">Tutoriels</a></li>
			...
			<div class="banner-main">
				 <section class="slider">
						...
						<ul class="slides">
						  <li>
						  	<div class="banner-main">
								   <h3>ESTG-LEARNING EN LIGNE.</h3>
						            <p>Un accueil chaleureux à mon propre site Elearning-ESTG Une façon économique d’apprendre, site tutoriel en ligne.</p>
								<div class="clearfix"> </div>
							</div>
						  </li>
<!--
